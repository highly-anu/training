...
export const PHASE_COLORS: Record<TrainingPhase, PhaseColor> = {
  ...
  build: { hex: '#f59e0b', bg: 'bg-amber-500/15', text: 'text-amber-800 dark:text-amber-300', label: 'Build' },
  peak: { hex: '#ef4444', bg: 'bg-red-500/15', text: 'text-red-700 dark:text-red-300', label: 'Peak' },
  taper: { hex: '#22c55e', bg: 'bg-green-500/15', text: 'text-green-800 dark:text-green-300', label: 'Taper' },
  ...
  rehab: { hex: '#84cc16', bg: 'bg-lime-500/15', text: 'text-lime-800 dark:text-lime-300', label: 'Rehab' },
  ...
  specific: { hex: '#f97316', bg: 'bg-orange-500/15', text: 'text-orange-800 dark:text-orange-300', label: 'Specific' },
}
